...
(defun hal-find-groovy-type()
  "Search for all Groovy files that match the word under point and display in the HAL-OUTPUT buffer."
  (interactive)
  (hal-find-file (thing-at-point 'word) "*.groovy"))
